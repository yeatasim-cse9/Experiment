  ...
  return (
    <div className="w-full max-w-md mx-auto py-16 px-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="text-center mb-10">
        <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-white mb-2">Create an Account</h1>
        <p className="text-gray-500 dark:text-gray-400">Join CampusGig to start posting & finding work.</p>
      </div>
      ...
      <div className="bg-white dark:bg-zinc-900 shadow-sm border border-gray-100 dark:border-zinc-800 rounded-3xl p-8">
        ...
        <div className="relative flex items-center my-8">
          ...
          <span className="flex-shrink-0 mx-4 text-sm font-medium text-gray-400">OR REGISTER WITH</span>
          <div className="flex-grow border-t border-gray-200 dark:border-zinc-800"></div>
        </div>
